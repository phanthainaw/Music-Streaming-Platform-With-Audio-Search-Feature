...
(async () => {
  try {
    ...
    // const outputFilePath = './uploads/Track/1.wav';
    const pcm = await extractPCM("./uploads/Track/1.wav", true);
    ...
    matchedCouples = await mongo.getMatchingCouples(Object.keys(fingerprints)); 
    console.log(matchedCouples);
